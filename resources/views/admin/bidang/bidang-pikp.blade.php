...
@section('title', 'Data Magang Bidang PIKP')

@section('content')
<div class="container my-4">
    <h2 class="mb-4 fw-semibold text-center text-md-start">Data Magang – Bidang PIKP</h2>
    ...
    <div class="table-responsive">
        <table class="table table-striped align-middle">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-center text-muted">Belum ada data magang di bidang PIKP.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
