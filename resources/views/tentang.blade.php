    ...
    <footer class="custom-footer mt-5">
        <div class="container-fluid px-5">
            ...
            <div class="row align-items-center py-5">
                <div class="col-lg-6">
                    <h3 class="fw-bold">SiPeKa – Sistem Informasi PKL</h3>
                    <p class="opacity-75 mb-0">
                        Platform digital untuk mendukung pengelolaan peserta PKL secara tertib,
                        transparan, dan berkelanjutan.
                    </p>
                </div>

                <div class="col-lg-6 text-lg-end mt-3 mt-lg-0">
                    <a href="#" class="btn btn-warning rounded-pill px-4 py-2 text-white">
                        Jelajahi Aplikasi
                    </a>
                </div>
            </div>
            ...
            <div class="row align-items-center py-3 small">
                ...
                <div class="col-md-4 text-md-end text-center mt-2 mt-md-0 opacity-75">
                    Dinas Komunikasi, Informatika, dan Statistik Kota Denpasar
                </div>
            </div>
